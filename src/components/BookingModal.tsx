        ...
        <div className="px-6 pt-5 pb-8 space-y-5">
          ...
          {step === 'success' && (
            <div className="flex flex-col items-center py-6 gap-4">
              <div className="w-20 h-20 rounded-full bg-[#49e619]/20 flex items-center justify-center">
                <span className="material-symbols-outlined text-[#3acc0f] text-[40px]">check_circle</span>
              </div>
              <div className="text-center">
              ...
              <div className="w-full bg-slate-50 rounded-2xl px-5 py-3.5 space-y-2">
